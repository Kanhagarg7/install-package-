...
#
# ported to kanha by dot arc (@moiusrname)
...
from . import async_searcher, LOGS, kanha_cmd, eor, get_string


@kanha_cmd(pattern="p( ([\s\S]*)|$)",manager=True)
...
@kanha_cmd(pattern="m( (.*)|$)",manager=True)
async def msg(event):
